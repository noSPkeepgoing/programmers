# [PCCE 모의고사 2] 7번
# 문제 설명
# "0 10 123 45 678"과 같은 문자열이 주어질 때, 이를 "010-1234-5678"과 같은 전화번호 형식 문자열로 바꾸려 합니다.
# 문자열 입력이 저장된 phone과 다음 함수들이 주어질 때 이를 적절하게 호출하여 "010-XXXX-XXXX"(X는 숫자)와 같은 형식의 문자열을 return하는 함수를 완성해 주세요.
